...
An important objective from a project managers perspective is to reduce the number of feed-back marks to minimize the potential conflicts that could arise during the execution of tasks. This process is regarded as \textit{partitioning}~\cite{steward1981,Yassine01091999}.
