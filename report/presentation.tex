  ...
  \begin{columns}[T]
    \begin{column}{0.42\textwidth}
      ...
      \begin{tabular}{lcc}
        ...
        + Tearing      & 84.12\%  & 93.95\% \\
        + Banding      & \highlight{84.15\%}  & \highlight{94.54\%} \\
        \bottomrule
      \end{tabular}
      \vspace{0.5em}
      \begin{itemize}
    ...
    \begin{column}{0.55\textwidth}
      \begin{block}{Selected matrix results}
        ...
        \begin{tabular}{lrrr}
          \toprule
          Matrix & FBM$_0 \to$ FBM$_f$ & TFBD$_0 \to$ TFBD$_f$ \\
          \midrule
          Tina\_AskCal & $12 \to 4$       & $32 \to 7$ \\
          California   & $6063 \to 192$   &$18$M $\to 669$\\
          wb-cs-stanford & $20131 \to 8537$ & $8.7$M $\to 1.78$M\\
	  HEP-th-new   & $104435 \to 8281$ & $1.7$B $\to 10.1$M \\
          \bottomrule
        \end{tabular}
      \end{block}
    \end{column}
    ...
    \begin{column}{0.48\textwidth}
      \begin{block}{What we achieved}
        \begin{itemize}
          ...
          \item Tearing via \textbf{Algorithm~GR} (greedy FBM reduction), banding via \textbf{Reverse Cuthill-McKee} + adjacent-swap refinement (TFBD reduction)
          \item \highlight{84.15\% average FBM reduction}, \highlight{94.54\% average TFBD reduction} across 10 benchmark matrices
        \end{itemize}
      \end{block}
    \end{column}
    \begin{column}{0.48\textwidth}
...
\begin{frame}{Acknowledgements \& Team Contributions}
  ...
  \begin{block}{AI Disclosure}
    \small Claude (Opus 4.6 \& Sonnet 4.6) and ChatGPT (GPT-4o) were used to understand algorithms/terminology and to write Python plotting scripts. All C\texttt{++} code and report text were written by the authors without AI assistance.
  \end{block}
  ...
  \begin{block}{Team Member Contributions}
    ...
    \begin{tabular}{l p{0.70\textwidth}}
      ...
      \midrule
      Simon Kraft   & Implemented Tarjan's algorithm, Topological Sort, and python scripts for original vs permuted DSM. Wrote report introduction and abstract. \\
      Joshua Payne  & Implemented Kosaraju-Sharir algorithm, tearing \& banding. Wrote report description of solution. \\
      El Sall       & Implemented permutation application, benchmark suite, python scripts for report figures. Wrote report numerical results section. \\
      \bottomrule
    \end{tabular}
  \end{block}
